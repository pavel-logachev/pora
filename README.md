...
> **Статус:** протестированный подписанный Android-релиз 1.0.2. Приложение проверено в реальном использовании и работает хорошо; APK, подпись, установка и основные сценарии дополнительно подтверждены release-проверками ниже. В Google Play приложение не опубликовано.
